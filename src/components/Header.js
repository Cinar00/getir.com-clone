        ...
        <div className='bg-brand-color'>
            <div className='container mx-auto h-16 md:h-11 flex items-center justify-center md:justify-between'>
                ...
                <nav className='hidden md:flex gap-8 text-sm '>
                    <a href="/" className='antialiased flex items-center gap-x-2 text-white transition-all text-opacity-80 hover:text-opacity-100'>
                        <BiGlobe  size={20}/>
                        Türkçe  (TR)
                    </a> 

                    <a href="/" className='font-semibold antialiased flex items-center gap-x-2 text-white transition-all text-opacity-80 hover:text-opacity-100'>
                        <RiUserFill size={20} />
                        Giriş yap
                    </a>
